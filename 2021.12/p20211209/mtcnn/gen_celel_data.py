                ...
                with Image.open(image_file) as img:  # 打开图片文件
                    ...
                    for _ in range(5):     # 每个循环5次，画五个框框、抠出来
                        ...
                        if iou > 0.8:  # 正样本；原为0.65
                            ...
                            positive_count += 1
                        elif iou > 0.4 and iou < 0.55 :  # 部分样本；原为0.4
                            ...
                            part_count += 1
                        elif iou < 0.05: # ★这样生成的负样本很少；原为0.3
                    ...
                    for i in range(5): # 数量一般和前面保持一样
                        ...
                        if np.max(utils.iou(crop_box, _boxes)) < 0.05:   # 在加IOU进行判断：保留小于0.3的那一部分；原为0.3
