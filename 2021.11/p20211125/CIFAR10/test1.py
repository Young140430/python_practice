...
train_data = datasets.CIFAR10("E:\CIFAR10",train=True,transform=transforms.ToTensor(),download=True)
train_loader = DataLoader(train_data,batch_size=500,shuffle=True)
test_data = datasets.CIFAR10("E:\CIFAR10",train=True,transform=transforms.ToTensor(),download=True)
