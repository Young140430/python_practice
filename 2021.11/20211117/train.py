        ...
        for epoch in range(100000):
            ...
            for i,(imgs,tags) in enumerate(self.train_loader):
                ...
                if i%10==0 and i!=0:
                    ...
                    # 收集训练损失
                    self.summaryWriter.add_scalar("train_loss_v4",avg_train_loss,train_step)
                    train_step += 1
                    train_sum_loss = 0
            score = 0
            #验证代码
            for i,(imgs,tags) in enumerate(self.test_loader):
                ...
                self.summaryWriter.add_scalar("score",score,test_step)
                    # self.summaryWriter.add_scalars("test_v4",
                    #                                {"train_loss_v4": avg_train_loss, "test_loss_v4": test_avg_loss},
                    #                                test_step)
                test_step += 1
