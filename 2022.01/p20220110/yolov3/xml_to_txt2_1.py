...
# 存放xml文件的文件夹路径
xml_directory = r"D:\VOC2007\VOCtrainval_06-Nov-2007\VOCdevkit\VOC2007\Annotations"
# txt文件
txt = open(r"D:\VOC2007\VOCtrainval_06-Nov-2007\VOCdevkit\VOC2007\label.txt", "w")
