    ...
    while True:
        for target_13, target_26, target_52, img_data in train_loader:
            ...
            if loss.item() < max_loss:
                max_loss = loss.item()
                torch.save(net.state_dict(), r"E:\yolov3_param\voc_best3.pt")
                print("save voc_best3.pt success")
            print("最小的loss===>",max_loss)
            if epoch % 10 == 0 and epoch > 0:
                torch.save(net.state_dict(), r"E:\yolov3_param\voc_last3.pt")
                print("save voc_last3.pt success")
            epoch += 1
